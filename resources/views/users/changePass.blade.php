...
<form action="{{ route('user.update') }}" method="post" class="card">
  {!! csrf_field() !!}
    ...
    <div class="card-header" style="background-color: yellow!important;">
...
<script>
  ...
  <div class="card-footer text-right">
    <div class="d-flex">
      ...
      <button type="submit" class="btn ml-auto text-bold" style="background-color: yellow">Enviar dados</button>
    </div>
  </div>
  </div>
</form>
